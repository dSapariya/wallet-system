  ...
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"> 
      <div class="text-center mb-8">
        <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Wallet System</h1> 
        <p class="text-gray-600 text-base sm:text-lg">Manage your digital wallet with ease</p> 
      </div>
